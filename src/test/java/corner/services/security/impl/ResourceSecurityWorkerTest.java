...
public class ResourceSecurityWorkerTest extends TapestryTestCase {
	...
	public void test_transform() {
		...
		train_extendMethod(ct, sig, "try{if(!_$checker.check($1)){throw new corner.exceptions.AclException(\"Can't access\");}}catch(Throwable te){throw new RuntimeException(te);}");
