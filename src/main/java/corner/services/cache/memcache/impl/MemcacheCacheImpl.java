...
public class MemcacheCacheImpl<V> implements Cache<String, V> {
	...
	/**
	 * 
	 * @see corner.services.cache.Cache#get(java.lang.Object)
	 */
	...
	/**
	 * @see corner.services.cache.Cache#put(java.lang.Object, java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see corner.services.cache.Cache#remove(java.lang.Object)
	 */
	@Override
