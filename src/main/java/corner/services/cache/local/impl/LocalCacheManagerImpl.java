...
import corner.services.cache.CacheManager;
...
public class LocalCacheManagerImpl implements CacheManager {
	...
	/**
	 * @see corner.services.cache.CacheManager#getCache(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see corner.services.cache.CacheManager#start()
	 */
	@Override
	public void start() {
	...
	/**
	 * @see corner.services.cache.CacheManager#stop()
	 */
	@Override
	public void stop() {
