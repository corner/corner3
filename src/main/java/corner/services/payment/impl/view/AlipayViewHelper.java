 ...
 */
package corner.services.payment.impl.view;
...
public class AlipayViewHelper extends AbstractViewHelper {
	...
	/**
	 * @see corner.services.payment.ViewHelper#sign()
	 */
	@Override
	public void sign() {
	...
	/**
	 * @see corner.services.payment.impl.view.AbstractViewHelper#outputFieldInformation(org.apache.tapestry5.json.JSONObject)
	 */
	@Override
