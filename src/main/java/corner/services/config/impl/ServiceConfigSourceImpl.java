...
import corner.services.config.ConfigInitable;
import corner.services.config.ServiceConfigSource;
...
public class ServiceConfigSourceImpl implements ServiceConfigSource {
	...
	/**
	 * 
	 * @see corner.services.config.ServiceConfigSource#getServiceConfig(java.lang.Class)
	 */
	@Override
