...
public class PegNum extends AbstractValidator<Long, Number> {
	...
	public PegNum(ValidatorRenderSupport delegate) {
		super(Long.class, Number.class, "pegnum");
	...
	public void render(Field field, Long constraintValue,
		...
		options.put("wrongNumberMessage", buildMessage(formatter, field,constraintValue));
