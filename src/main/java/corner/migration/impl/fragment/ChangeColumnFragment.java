 ...
 */
package corner.migration.impl.fragment;
...
public class ChangeColumnFragment extends AbstractMigrateFragment {
	...
	/**
	 * @see corner.migration.MigrateFragment#generateMigrationFragments(org.hibernate.mapping.Table, org.hibernate.tool.hbm2ddl.TableMetadata)
	 */
	@Override
