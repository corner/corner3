 ...
 */
package corner.payment.impl.view;
...
public class AlipayViewHelper extends AbstractViewHelper {
	...
	/**
	 * @see corner.payment.ViewHelper#sign()
	 */
	@Override
	public void sign() {
	...
	/**
	 * @see corner.payment.impl.view.AbstractViewHelper#outputFieldInformation(org.apache.tapestry5.json.JSONObject)
	 */
	@Override
