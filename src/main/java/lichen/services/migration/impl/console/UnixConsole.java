 ...
 */
package lichen.services.migration.impl.console;
...
public class UnixConsole implements IConsole{
    ...
    private Map<ConsoleForegroundColor,String> fcolors = new HashMap<ConsoleForegroundColor,String>();

    /** Map of background colors. */
    private Map<ConsoleBackgroundColor,String> bcolors = new HashMap<ConsoleBackgroundColor,String>();
