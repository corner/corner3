 ...
 */
package lichen.services.payment.impl;

import java.util.Map;

import lichen.services.payment.PaymentProcessor;
import lichen.services.payment.PaymentServiceSource;
...
public class PaymentServiceSourceImpl implements PaymentServiceSource {
	...
	/**
	 * @see lichen.services.payment.PaymentServiceSource#getPaymentProcessor(java.lang.String)
	 */
	@Override
