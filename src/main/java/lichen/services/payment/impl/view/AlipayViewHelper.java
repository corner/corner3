 ...
 */
package lichen.services.payment.impl.view;
...
public class AlipayViewHelper extends AbstractViewHelper {
	...
	/**
	 * @see lichen.services.payment.ViewHelper#sign()
	 */
	@Override
	public void sign() {
		...
		sb.append(this.key);
		System.out.println("from lichen:");
	...
	/**
	 * @see lichen.services.payment.impl.view.AbstractViewHelper#outputFieldInformation(org.apache.tapestry5.json.JSONObject)
	 */
	@Override
