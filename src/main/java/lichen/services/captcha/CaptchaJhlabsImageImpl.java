 ...
 */
package lichen.services.captcha;
...
public class CaptchaJhlabsImageImpl implements CaptchaImage {
	...
	/**
	 * @see lichen.services.captcha.CaptchaImage#converString2Image(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see lichen.services.captcha.CaptchaImage#getMimeType()
	 */
	@Override
