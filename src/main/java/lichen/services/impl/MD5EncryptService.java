...
import lichen.services.EncryptService;
...
public class MD5EncryptService implements EncryptService {
	...
	/**
	 * @see lichen.services.EncryptService#decrypt(byte[], byte[])
	 */
	@Override
	...
	/**
	 * @see lichen.services.EncryptService#decrypt(java.lang.String)
	 */
	@Override
	 ...
	 * @see lichen.services.EncryptService#encrypt(byte[], byte[])
	 */
	@Override
	...
	/**
	 * @see lichen.services.EncryptService#encrypt(java.lang.String)
	 */
	@Override
