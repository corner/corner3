 ...
 */
package lichen.services.hadoop;

import java.util.Map;

import lichen.services.hadoop.impl.DistributedResourceEventResultProcessorWrapper;
import lichen.services.hadoop.impl.DistributedResourceComponentEventResultProcessor;
import lichen.services.hadoop.impl.GetFileServiceRegexClearImpl;
import lichen.services.hadoop.impl.HadoopAccessorImpl;
...
public class HadoopModule {
	public final static String HADOOP_DFS_NAME_VAR = "lichen.hadoop.dfs";
	public final static String HADOOP_WEB_URL = "lichen.hadoop.web.url";
	/** Hadoop客户端建立Socket的连接超时* */
	public static final String HADOOP_CLIENT_SOCKETTIMEOUT = "lichen.hadoop.sockettimeout";
	/** Hadoop客户端建立Socket的连接超时后的重次次数* */
	public static final String HADOOP_DFS_CLIENT_SOCKETTIMEOUT_MAXRETRIES = "lichen.hadloop.sockettimeout.maxretries";
	/** Hadoop向Web返回响应时是否Cache* */
	public final static String HADOOP_WEB_CACHE = "lichen.hadoop.web.cache";
	...
	public static void contributeFactoryDefaults(
		...
		configuration.add(HADOOP_WEB_URL, "/lichen/getfile");
