...
public class StaticAssetUrlFactoryDomainImpl implements StaticAsseUrlFactory {
	/** 配置domain * */
	public static final String LICHEN_STATICASSET_DOMAINFACTORY_DOMAIN = "lichen.staticasset.domainfactory.domain";
	/** 配置是否使用泛域名解析 * */
	public static final String LICHEN_STATICASSET_DOMAINFACTORY_SUPPORT_MUTIL = "lichen.staticasset.domainfactory.mutil";
