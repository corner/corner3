...
public class StaticAssetUrlDomainSequenceHash implements
	...
	/** 配置用于散列的域名个数 * */
	public static final String LICHEN_STATICASSET_DOMAINFACTORY_SEHASH_COUNT = "lichen.staticasset.domainfactory.sehash.count";
	...
	/**
	 * @see lichen.services.asset.StaticAssetUrlDomainHash#hash(java.lang.String)
	 */
	@Override
