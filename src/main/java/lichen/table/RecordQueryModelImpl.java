...
public class RecordQueryModelImpl implements QueryModel {
	...
	/**
	 * @see lichen.table.QueryModel#createActionLink(int)
	 */
	@Override
	...
	/**
	 * @see lichen.table.QueryModel#getCurrentPage()
	 */
	@Override
	...
	/**
	 * @see lichen.table.QueryModel#getCurrentPageRecord()
	 */
	@Override
	...
	/**
	 * @see lichen.table.QueryModel#getRowCount()
	 */
	@Override
	...
	/**
	 * @see lichen.table.QueryModel#getRowsPerPage()
	 */
	@Override
