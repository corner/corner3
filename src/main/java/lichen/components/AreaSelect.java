...
import lichen.area.AreaModel;
import lichen.area.AreaModelCallback;
import lichen.area.AreaModelImpl;
import lichen.area.AreaModelItem;
import lichen.area.AreaSelectField;
...
public class AreaSelect extends AbstractField implements AreaSelectField{
	...
	/**
	 * @see lichen.area.AreaSelectField#getProvinceField()
	 */
	...
	/**
	 * @see lichen.area.AreaSelectField#getCityField()
	 */
	...
	/**
	 * @see lichen.area.AreaSelectField#getTownField()
	 */
