 ...
 * @since 0.0.1
 */
public final class MostLength extends AbstractValidator<Integer, String> {

	private ValidatorRenderSupport delegate;

	public MostLength(ValidatorRenderSupport delegate) {
		super(Integer.class, String.class, "mostLength");
	...
	public void render(Field field, Integer constraintValue,
		...
		options.put("tooLongMessage", buildMessage(formatter, field,constraintValue));
